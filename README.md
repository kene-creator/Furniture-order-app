...
# React Furniture store web app

> This is a demo Furniture web app store
...
- To clone the project on your machine: Type `git clone https://github.com/kene-creator/Furniture-order-app.git`.
...
Feel free to check the [issues page](https://github.com/kene-creator/Furniture-order-app.git/issues).
