      ...
      <div className="flex">
        <div className="basis-2/5 ml-24">
          ...
          <p className="mt-8 font-extralight font-sans">
            ...
            nihil excepturi architecto, ipsa ad modi maxime odit corporis
            possimus consequatur numquam.
          </p>
          <button className="bg-[#C4A586] text-white py-2 px-4 mt-6 font-extralight mr-6">
            Request a Qoute
          </button>
          <button className="py-2 px-4 font-extralight border-[#C4A586] border border-solid text-[#C4A586]">
            Watch a video
          </button>
        </div>
